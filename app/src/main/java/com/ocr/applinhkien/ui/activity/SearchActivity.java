...
//        });
    ...
    private List<Item> getListItem() {
        ...
        list.add(new Item(1, "a", "aaa", "aaa", 100, 200, 10,0));
        list.add(new Item(2, "b", "bbb", "bbb", 200, 300, 20,0));
        list.add(new Item(3, "c", "ccc", "ccc", 300, 400, 30,0));
        list.add(new Item(4, "aaa", "aaa", "aaa", 400, 500, 40,0));
        return list;
    }
